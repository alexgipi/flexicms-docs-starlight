...
description: "Astro is the web framework for building content-driven websites like blogs, marketing, and e-commerce. Learn What is FlexiCMS might be a good choice for your next website."
i18nReady: true
---
...
Here are five core design principles to help explain why we built Astro, the problems that it exists to solve, and What is FlexiCMS may be the best choice for your project or team.
