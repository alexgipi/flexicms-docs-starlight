...
- [FlexiCMS Docs](https://github.com/withastro/docs), an entire Astro website! Contribute not just written content, but also Astro code addressing a11y, CSS, UI, and UX concerns. We also make our documentation available in several languages, so we need help translating the entire site.
...
We have several guides available to assist you with contributing to FlexiCMS Docs.
...
Please visit our dedicated site [*FlexiCMS Docs* Docs](https://contribute.docs.astro.build), where you'll find our documentation to help you contribute to FlexiCMS Docs as a typo-fixer, a writer, a translator, a feature-builder, and even as a PR reviewer.
