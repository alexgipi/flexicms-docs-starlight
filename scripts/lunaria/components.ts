...
export const Meta = html`
	...
	<title>FlexiCMS Docs Translation Status</title>
	<meta
		name="description"
		content="Translation progress tracker for the FlexiCMS Docs site. See how much has been translated in your language and get involved!"
	/>
	<meta property="last-build" content="${new Date(Date.now()).toString()}" />
	<link rel="canonical" href="https://i18n.docs.astro.build/" />
	<meta property="og:title" content="FlexiCMS Docs Translation Status" />
	...
	return html`
		<main>
			<div class="limit-to-viewport">
				<h1>FlexiCMS Docs Translation Status</h1>
